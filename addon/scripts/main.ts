...
const mob_loot = new CustomPlayerKillMobLoot(mob_loot_table);
world.afterEvents.entityDie.subscribe((entityDieAfterEvent: EntityDieAfterEvent) => { mob_loot.onEntityDie(entityDieAfterEvent) } );

const creaking = new CreakingToyDrop( 0.1, "toy:toy_creaking" );
world.afterEvents.entityHitEntity.subscribe( (entityHitEntity: EntityHitEntityAfterEvent) => { creaking.onEntityHit(entityHitEntity); } );
